...
!
! special version for idealised LES of isolated cold pools (Bettina)
! Dec 2018 
!
...
write(*,*) "setting # sub-timesteps to ", n_sub
 ...
 DO timestep = onset,tracking_end
   ...
   CALL write_output(traced, max_tracers, count_tracer, timestep, tracpo, max_no_of_cells, COMx, COMy)
...
SUBROUTINE write_output(traced, max_tracers, count_tracer, timestep, tracpo, max_no_of_cells, COMx, COMy)
